document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    th: {
      ...
      filter_special: "ของทานเล่น & เมนูพิเศษ",
      ...
      // New corrected menu translations
      menu_t1: "ปังปิ้งราดช็อกโกแลตเข้มข้น",
      menu_d1: "ขนมปังปิ้งเตาถ่านกรอบนอกนุ่มใน ราดซอสช็อกโกแลตเข้มข้นหวานมันสะใจ",
      menu_t2: "นักเก็ตทองคำ & เกี๊ยวซ่าทอด",
      menu_d2: "ของทานเล่นยอดฮิต นักเก็ตไก่ทอดกรอบสีทองอร่อยเคี้ยวเพลิน เสิร์ฟคู่ซอสสูตรเด็ด",
      menu_t3: "ปังปิ้งเนยสังขยา & นมสดร้อน",
      menu_d3: "เซ็ตจับคู่สุดคุ้ม ขนมปังปิ้งทาเนยสังขยาหอมหวาน เสิร์ฟพร้อมนมสดร้อนแท้ 100% ในแก้วสุดวินเทจ",
      menu_t4: "ปังเย็นโกโก้ภูเขาไฟ",
      menu_d4: "ปังเย็นโกโก้ถ้วยยักษ์ ท็อปปิ้งล้นๆ ด้วยคอนเฟลกและโอวัลตินโรล ทานคู่ขนมปังเนยนมฟินๆ",
      menu_t5: "เฟรนช์ฟรายส์ทอดกรอบ",
      menu_d5: "เฟรนช์ฟรายส์ทอดร้อนๆ กรอบนอกนุ่มใน เสิร์ฟพร้อมดิปปิ้งซอสรสชาติต่างๆ ทานเล่นเพลินๆ",
      menu_t6: "นมชมพูเย็นหวานละมุน",
      menu_d6: "นมเย็นสีชมพูสุดน่ารัก รสชาติหวานมันกลมกล่อม หอมกลิ่นสละไซรัปแบบไทยดั้งเดิม",
      menu_t7: "ปังปิ้งไมโลภูเขาไฟ",
      menu_d7: "ขนมปังปิ้งเตาถ่านชุ่มเนย โรยด้วยผงไมโลภูเขาไฟและราดนมข้นหวานเยิ้มสะใจ",
    ...
    en: {
      ...
      filter_special: "Snacks & Specials",
      menu_badge_best: "Best Seller ⭐",
      menu_badge_sig: "Signature 🌟",
      menu_badge_rec: "Highly Recommended 🔥",
      menu_badge_healthy: "Healthy Choice 🥛",
      ...
      menu_t1: "Rich Chocolate Drizzled Toast",
      menu_d1: "Charcoal-grilled toast, crispy on the outside and soft inside, drizzled with rich sweet chocolate sauce.",
      menu_t2: "Golden Nuggets & Fried Wontons",
      menu_d2: "Super popular snack: golden crispy chicken nuggets and fried wontons served with a special dipping sauce.",
      menu_t3: "Butter Kaya Toast & Hot Milk",
      menu_d3: "Value combo set: charcoal butter-kaya toast paired with a hot mug of 100% fresh milk in a vintage tin cup.",
      menu_t4: "Volcano Cocoa Shaved Ice Bowl",
      menu_d4: "Giant bowl of shaved ice cocoa, heavily topped with cornflakes, wafer rolls, and sweet condensed milk toast.",
      menu_t5: "Crispy Golden French Fries",
      menu_d5: "Hot fried french fries, crispy on the outside and soft inside, served with assorted dipping sauces.",
      menu_t6: "Sweet Pink Milk",
      menu_d6: "Sweet and creamy cold pink milk infused with traditional red sala syrup. A classic local favorite!",
      menu_t7: "Milo Volcano Toast",
      menu_d7: "Charcoal-grilled butter toast heavily dusted with Milo powder and drizzled with sweet condensed milk.",
    ...
    zh: {
      ...
      hero_desc: "享受优质纯鲜牛奶与传统炭烤土司 the 完美结合——香气四溢，外酥内软，入口即化。这里是内容创作者和单身人士的极佳去处！",
      hero_btn_menu: "查看菜单 😋",
      hero_btn_loc: "门店位置 📍",
      menu_title: "招牌菜单",
      ...
      menu_t1: "浓郁巧克力淋酱土司",
      menu_d1: "炭烤土司外酥内软，淋上浓郁香甜的巧克力酱，令人大饱口福。",
      menu_t2: "金黄鸡块 & 炸饺子",
      menu_d2: "人气小吃：金黄酥脆的炸鸡块和炸饺子，搭配特色蘸酱，酥脆可口。",
      menu_t3: "黄油咖椰土司 & 热鲜奶",
      menu_d3: "超值套餐：炭烤黄油咖椰土司，搭配复古钢杯盛装的100%纯热鲜牛奶。",
      menu_t4: "火山可可刨冰碗",
      menu_d4: "巨型可可刨冰碗，铺满玉米片、阿华田卷，搭配甜炼乳土司，冰爽解暑。",
      menu_t5: "金黄香脆炸薯条",
      menu_d5: "现炸热乎乎的炸薯条，外酥内软，搭配多种精选蘸酱，美味爽口。",
      menu_t6: "香甜玫瑰冰奶",
      menu_d6: "可爱的粉红冰牛奶，口感香甜浓郁，融入了泰式传统的蛇皮果糖浆香气。",
      menu_t7: "美禄火山炭烤土司",
      menu_d7: "炭烤土司涂满黄油，撒上厚厚的美禄可可粉，再淋上满满的甜炼乳，大满足！",
